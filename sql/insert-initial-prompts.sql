-- Inserir prompts iniciais na tabela cedro.cerebro
-- Execute após criar a tabela

-- Prompt para Anamnese (Primeira Consulta)
INSERT INTO cedro.cerebro (
    modulo, 
    nome_display, 
    system_prompt, 
    descricao, 
...
Agora, analise a transcrição fornecida e gere o prontuário de anamnese estruturado seguindo exatamente este formato.',
    'Prompt para gerar prontuários estruturados de primeira consulta (anamnese) em psicologia/psiquiatria',
    '1.0',
    'sistema'
);

-- Prompt para Consultas Regulares (Evolução)
INSERT INTO cedro.cerebro (
    modulo, 
    nome_display, 
    system_prompt, 
...
Agora, analise a transcrição fornecida e gere o prontuário de consulta regular estruturado seguindo exatamente este formato.',
    'Prompt para gerar prontuários estruturados de consultas regulares (evolução) em psicologia/psiquiatria',
    '1.0',
    'sistema'
);

-- Verificar se os dados foram inseridos
SELECT modulo, nome_display, versao, ativo, created_at 
FROM cedro.cerebro 
ORDER BY modulo;